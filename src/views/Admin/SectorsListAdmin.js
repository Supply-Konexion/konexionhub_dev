...
import EditSectorsAdmin from "views/dialog/EditSectorsAdmin";
import NewSectorAdmin from "views/dialog/NewSectorAdmin";
...
export default function SectorsListAdmin() {
    ...
    <GridContainer>
      <GridItem xs={12} sm={12} md={12}>
        <div className={classes.cardTitleBlack}>
          <List className={classes.iconFilter} /> Listado de sectores
        </div>
        <Card>
          <CardBody>
